    ...
    <footer className="bg-card border-t">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground">
              Cel mai mare magazin online de mobilier din România. 
              Calitate superioară și livrare rapidă în toată țara.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-muted-foreground">
              <li><a href="#" className="hover:text-foreground transition-colors">Living</a></li>
              <li><a href="#" className="hover:text-foreground transition-colors">Dormitor</a></li>
              <li><a href="#" className="hover:text-foreground transition-colors">Bucătărie</a></li>
              <li><a href="#" className="hover:text-foreground transition-colors">Birou</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-muted-foreground">
              ...
              <li className="flex items-center space-x-2">
                ...
                <span>contact@furnistore.ro</span>
              </li>
              <li className="flex items-center space-x-2">
        ...
        <div className="border-t mt-8 pt-8 text-center text-muted-foreground">
          <p>&copy; 2024 FurniStore. Toate drepturile rezervate.</p>
        </div>
      </div>
    </footer>
  );
