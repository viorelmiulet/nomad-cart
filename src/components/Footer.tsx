        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12">
          ...
          <div>
            ...
            <ul className="space-y-2 md:space-y-3 text-brand-cream/70 font-inter text-sm md:text-base">
              ...
              <li><button onClick={() => handleCategoryClick("Living Modern")} className="hover:text-brand-gold transition-colors duration-300 text-left touch-manipulation py-1">Living Modern</button></li>
            </ul>
          </div>
